...
# Load pup-male results to concatenate to, because all pup-male-male recaptures we do not need to do again as male-male
load(paste0(file_path_out, "results_pup_male19_01_24.Rdata")) 
